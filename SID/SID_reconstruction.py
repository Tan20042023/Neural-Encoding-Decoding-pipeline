...
def parse_args():
    ...
    parser.add_argument("--model-path", default=r"SID\weights\movie\movie01\SID_best.keras")
    parser.add_argument("--sid-model-path", default=r"SID\weights\movie\movie01\SID_best.keras")
    parser.add_argument("--encoded-spike-path", default=r"CNN\results\movie\movie01\predictions.mat")

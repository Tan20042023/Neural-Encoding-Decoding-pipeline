...
def test_GLM(
    ...
    pred = model.predict([x_test, h_test], batch_size=batch_size, verbose=0)
    loss, mse, cc = model.evaluate([x_test, h_test], y_test, batch_size=batch_size, verbose=0)

...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate CNN encoding model")
    parser.add_argument("--data-path", default=r"Dataset\movie\movie01.mat")
    parser.add_argument("--model-path", default=r"CNN\weights\movie\movie01\CNN_best.keras")
